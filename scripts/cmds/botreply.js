...
‎
    ...
    var rand = Messages[Math.floor(Math.random() * Messages.length)]
        ...
        if ((event.body.toLowerCase() == "Call me") || (event.body.toLowerCase() == "call")) {
    ...
    if ((event.body.toLowerCase() == "cup") || (event.body.toLowerCase() == "চুপ")) {
     return api.sendMessage("️--Amr Mukh, Amr iccha, Amr Mon. Tor ki bal,,,shala abal...ja vaag...!!😒🙄", threadID, messageID);
   };
  ...
  if ((event.body.toLowerCase() == "Tomar nam ki") || (event.body.toLowerCase() == "tmr nam ki")) {
     return api.sendMessage("️ --নাম যায় না কি করবি আমি সানি লিওনের ক্যামেরা ম্যান এইটুকু জেনে রাখ..!!☹️", threadID, messageID);
   };

  if ((event.body.toLowerCase() == "Inbox") || (event.body.toLowerCase() == "in")) {
  ...
  if ((event.body.toLowerCase() == "hmm") || (event.body.toLowerCase() == "Hmm")) {
     return api.sendMessage("️🙄-- এতো হুম হুম না করে,  দিরেক্ট ভালোবাসি বল..!!🍆", threadID, messageID);
   };
  ...
  if ((event.body.toLowerCase() == "Good night") || (event.body.toLowerCase() == "night") || (event.body.toLowerCase() == "good night")) {
  ...
  if ((event.body.toLowerCase() == "by")) {
   ...
   if ((event.body.toLowerCase() == "Tnx") || (event.body.toLowerCase() == "ধন্যবাদ")) {
     return api.sendMessage("️--মানুষ মাত্রই ভুল ক্ষমা চায়ার মাইরে সালাম..!!😚🖤", threadID, messageID);
   };
  ...
  if (event.body.indexOf("bbz") == 0 || (event.body.toLowerCase() == "bbs") || (event.body.indexOf("বট") == 0)) {
    var msg = {
      body: ` ${rand}`
    }
