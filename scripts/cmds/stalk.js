  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (args.length > 0 && args[0] === 'fb') {
      ...
      try {
        ...
        const messageBody = `
        ╭──『 𝗚𝗜𝗧𝗛𝗨𝗕 𝗦𝗧𝗔𝗟𝗞 』
        ✧ 𝙽𝙰𝙼𝙴: ${userProfile.name}
        ✧ 𝚄𝚂𝙴𝚁 𝙽𝙰𝙼𝙴: ${userProfile.username}
        ✧ 𝙱𝙸𝙾: ${userProfile.bio}
        ✧ 𝙵𝙾𝙻𝙻𝙾𝚆𝙴𝚁𝚂: ${userProfile.followers}
        ✧ 𝙵𝙾𝙻𝙻𝙾𝚆𝙸𝙽𝙶: ${userProfile.following}
        ✧ 𝚃𝙾𝙰𝚃𝙰𝙻 𝙿𝚄𝙱𝙻𝙸𝙲 𝚁𝙴𝙿𝙾: ${userProfile.publicRepos}
        ✧ 𝙻𝙾𝙰𝙲𝙰𝚃𝙸𝙾𝙽: ${userProfile.location}
        ✧ 𝙲𝚁𝙴𝙰𝚃𝙸𝙾𝙽 𝙳𝙰𝚃𝙴: ${userProfile.createdAt}
        ✧ 𝙿𝚁𝙾𝙵𝙸𝙻𝙴 𝚄𝚁𝙻: ${userProfile.githubUrl}
        ✧ 𝙿𝚁𝙾𝙵𝙸𝙻𝙴 𝙿𝙸𝙲𝚃𝚄𝚁𝙴:
        ╰───────────◊
        `;
        const messageToSend = {
