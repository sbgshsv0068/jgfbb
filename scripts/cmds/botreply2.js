...
config: {
    name: "jerry",
    version: "1.0",
    author: "RB-BADOL-KHAN",//Moded by RANA
    countDown: 5,
    role: 0,
 ...
 onStart: async function ({  }) { },
  ...
  var Messages = ["বেশি জেরি জেরি করলে চুম্মা দিয়া তোমার কিডনি ব্লক করে দেবো 😒 " , "শুনবো না😼তুমি আমাকে প্রেম করাই দাও নাই🥺পচা তুমি🥺" , "আমি আবাল দের সাথে কথা বলি না,ok😒" , "এতো ডেকো না,প্রেম এ পরে যাবো তো🙈" , "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈💋 " , "বার বার ডাকলে মাথা গরম হয়ে যায় কিন্তু😑", "হ্যা বলো😒, তোমার জন্য কি করতে পারি😐😑?" , "এতো ডাকছিস কেন?গালি শুনবি নাকি? 🤬" , "I love you janu 🥰" , "আরে Bolo আমার জান ,কেমন আছো?😚 " , "এত যে জেরি জেরি করো তোমরা কি আমার ভাতার লাগো 🥴" , "Hop beda😾,Boss বল boss😼" , "চুপ থাক ,নাই তো তোর দাত ভেগে দিবো কিন্তু" , ", জেরি  না beb বল beb 😘 " , "বার বার Disturb করছিস কোনো😾,আমার জানুর সাথে ব্যাস্ত আছি😋" , "বোকাচোদা এতো ডাকিস কেন🤬" , "আমাকে ডাকলে ,আমি কিন্তু কিস করে দিবো😘 " , "আমারে এতো ডাকিস না আমি মজা করার mood এ নাই এখন😒" , "হ্যাঁ জানু , এইদিক এ আসো কিস দেই🤭 😘" , "দূরে যা, তোর কোনো কাজ নাই, শুধু জেরি জেরি করিস  😉😋🤣" , "তোর কথা তোর বাড়ি কেউ শুনে না ,তো আমি কোনো শুনবো ?🤔😂 " , "আমাকে ডেকো না,আমি ব্যাস্ত আছি" , "কি হলো , মিস করচ্ছিস নাকি🤣" , "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏" , "কালকে দেখা করিস তো একটু 😈" , "হা বলো, শুনছি আমি 😏" , "আর কত বার ডাকবি ,শুনছি তো" , "হুম বলো কি বলবে😒" , "বলো কি করতে পারি তোমার জন্য" , "আমি তো অন্ধ কিছু দেখি না🐸 😎" , "আর একবার আমার নাম ধরে ডাকলে তোরে কোলে করে বেডরুমে নিয়ে আসব 😉" , "বলো জানু 🌚" , "তোর কি চোখে পড়ে না আমি ব্যাস্ত আছি😒","হুম জান তোমার ওই খানে উম্মহ😑😘" , "আহ শুনা আমার তোমার অলিতে গলিতে উম্মাহ😇😘" , " jang hanga korba😒😬" , "হুম জান তোমার অইখানে উম্মমাহ😷😘" , "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি..!🥰" , "আমাকে এতো না ডেকে বস রানা কে একটা গফ দে 🙄" , "আমাকে এতো না ডেকে বস রানা কে একটা গফ দে 🙄"];
    ...
    var rand = Messages[Math.floor(Math.random() * Messages.length)]
       ...
       if ((event.body.toLowerCase() == "/murgi") || (event.body.toLowerCase() == "/murgi2")) {
         return api.sendMessage("--নবীন পোলাপান allow নাই..🙂👍", threadID);
       };
      ...
      if ((event.body.toLowerCase() == "gossip") || (event.body.toLowerCase() == "gossip koro")) {
       ...
       if ((event.body.toLowerCase() == "apni ke") || (event.body.toLowerCase() == "ke apni")) {
         return api.sendMessage("-*তোমার নানা..//-😑🤦‍♂️", threadID);
       };
 
       if ((event.body.toLowerCase() == "in") || (event.body.toLowerCase() == "In")) {
         return api.sendMessage("️--*এতো in in করোস কেন, সবার সামনে বলার সাহস নাই বুঝি..//-🙂👍", threadID);
       };
 
       if ((event.body.toLowerCase() == "kick") || (event.body.toLowerCase() == "Kick")) {
         return api.sendMessage("️--কিক খাওয়ার ইচ্ছা হচ্ছে নাকি..//-😒😦", threadID);
       };
 
       if ((event.body.toLowerCase() == "attention") || (event.body.toLowerCase() == "Attention")) {
         return api.sendMessage("️**SucK**🥵", threadID);
       };
  ...
  if ((event.body.toLowerCase() == "Boy")) {
   ...
   if ((event.body.toLowerCase() == "jerry koi")) {
     return api.sendMessage("--হুম বলো সুনা কি বলবা 🤭🖤", threadID, messageID);
   };
  ...
  if (event.body.indexOf("Jerry") == 0 || (event.body.toLowerCase() == "jerry") || (event.body.indexOf("জেরি") == 0)) {
    var msg = {
      body: ` ${rand}`
    }
